...
if __name__ == '__main__':
    ...
    checkpoint = torch.load('/research/pheng4/qdliu/hzyang/wilds/examples/epoch_2.pth')
    ...
    optimizer = torch.optim.Adam(
        ae_model.parameters(), lr=config.lr, weight_decay=1e-5)

    epoches = 100
    # Train loop
    epoch = 0
    torch.save(ae_model.state_dict(), f'checkpoint/ae_epoch_{epoch}.pth')
